"""
Django settings for ExamManual project.
...
SECRET_KEY = 'django-insecure-$ly#p^gok=y+m+k=&l!6d1@g0-a2(6rpx#^hkb^b8s6t*495wx'
...
WSGI_APPLICATION = 'ExamManual.wsgi.application'
